      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          <h1 className="text-3xl font font-semibold text-center my-7">
            About Scribble&apos;s Hub
          </h1>
          <div className="text-md text-gray-500 flex flex-col gap-6">
            <p>
              Welcome to Scribble&apos;s Hub! This blog was created by
              Developers as a personal project to share his thoughts and ideas
              with the world. We are passionate developer who loves to write
            ...
            <p>
              ...
              programming languages. We are always learning and exploring new
